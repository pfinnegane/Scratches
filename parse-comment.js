...
let test_string_2 = "#### This is another comment### This is out of comment ###$ This is a borked comment \n and multiline ###";
let test_string_3 = "### This is the first comment ### ### This is another comment \n but multiline ###";

function test_replaceCommentTags(test_string) {
    const split = test_string.replace(/\r\n|\n|\r/gm, " ").split(' ');
